...
| [2 — Системы RAG](https://stepik.org/a/290247) | Слой RAG (`app/rag/`) | `c02-*` |
| [3 — Поглощение данных](https://stepik.org/a/297067) | Конвейер поглощения (`app/ingestion/`) | `c03-*` |
| [4 — Инженерия контекста](https://stepik.org/a/290650) | Движок контекста (`app/context/`) | `c04-*` |
